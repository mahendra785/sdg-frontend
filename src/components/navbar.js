    ...
    <nav className="bg-emerald-500 p-4 shadow-md">
      <div className="container mx-auto h-[8vh] flex items-center justify-between">
        ...
        <div className="flex space-x-4">
          ...
          <a href="/about" className="text-xl text-green-700 hover:text-green-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300 ease-in-out hover:bg-green-200 hover:scale-105">
            About
          </a>
        </div>
